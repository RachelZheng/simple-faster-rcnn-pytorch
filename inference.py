...
def inference(**kwargs):
    ...
    f_pts = open(os.path.join(opt.eval_dir, 'inference_layer%d_%s_pts.txt'%(
        opt.n_layer_fix, opt.model_name)), 'w')
    f_bbox = open(os.path.join(opt.eval_dir, 'inference_layer%d_%s_bbox.txt'%(
        opt.n_layer_fix, opt.model_name)), 'w')
